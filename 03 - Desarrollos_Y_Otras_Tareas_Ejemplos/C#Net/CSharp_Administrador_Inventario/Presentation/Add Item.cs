...
namespace Inventory_System
{
	...
	public partial class Add_Item : Form
	{
		...
		void InsertBtnClick(object sender, EventArgs e)
		{
					...
					{
						MessageBox.Show("Por favor, ingrese un número válido", "Invalid Reorder Level", MessageBoxButtons.OK, MessageBoxIcon.Asterisk);
						return;
					} 
					...
					{
					  MessageBox.Show("Por favor, seleccione una unidad válida", "Invalid");
					  return;
					}
				 ...
				 try
				 {
                    ...
                    cmd.ExecuteNonQuery();
				    MessageBox.Show("Registro agregado!", "Message", MessageBoxButtons.OK, MessageBoxIcon.Information);  //inform the user
                    DataAccess.LogAction(this.userId, "Nuevo Item: " + newItem.ItemName);
