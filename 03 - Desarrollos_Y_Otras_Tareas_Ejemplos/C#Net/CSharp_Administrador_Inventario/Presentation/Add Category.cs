...
namespace Inventory_System
{
	...
	public partial class Add_Category : Form
	{
        ...
        void InsertBtnClick(object sender, EventArgs e)
		{
					...
					if(IsEmpty())
						{
							MessageBox.Show("El campo no puede quedar vacío", "Error: Empty Fields", MessageBoxButtons.OK, MessageBoxIcon.Asterisk);
						  return;
						}
        ...
        private void deleteToolStripMenuItem_Click(object sender, EventArgs e)
        {
            if (ItemlistBox.SelectedIndex < 0)
                return;
            DialogResult dialog = MessageBox.Show("¿Está seguro que quiere borrar la categoría? ", "", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
