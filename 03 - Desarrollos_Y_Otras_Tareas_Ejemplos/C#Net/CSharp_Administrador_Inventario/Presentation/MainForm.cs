...
namespace Inventory_System
{
	...
	public partial class MainForm : Form
	{
            ...
            try
            {
                ...
                if (datatable.Rows.Count != 0)
                {
                    ...
                    var notification = new System.Windows.Forms.NotifyIcon()
                    {
                        ...
                        BalloonTipText = "Usted tiene " + datatable.Rows.Count,
                    };
        ...
        private void requestTable_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (e.ColumnIndex == 0)
            {
                ...
                using (OleDbConnection accessConnection = new OleDbConnection(Connection.getConnectionString()))
                {
                    ...
                    try
                    {
                        ...
                        transaction.Commit();
                        MessageBox.Show("Autorizado", "Message", MessageBoxButtons.OK, MessageBoxIcon.Information);  //inform the user
                    }
                    catch (Exception ex)
                    {
                        MessageBox.Show("Intente nuevavente o contacte al Administrador...", "Connection Issue", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                        if(transaction != null)
            ...
            else if (e.ColumnIndex == 1)
            {
                using (OleDbConnection accessConnection = new OleDbConnection(Connection.getConnectionString()))
                {
                    ...
                    MessageBox.Show("No autorizado", "Message", MessageBoxButtons.OK, MessageBoxIcon.Information);  //inform the user
                    accessConnection.Close();
                }
        ...
        public bool RefreshItemStatus()
		{
            ...
            {
                MessageBox.Show("Contactar al Administrador...", "Connection Issue", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
            }
		...
		public void getNotifications()
		{
    		...
    		adapter.Fill(datatable);
    			if(CheckItemStatus())
    			{
		    		...
		    		{
		    			statusLbl.Text = "Inventario actualizado";
		    			...
		    			uptodatePic.Visible = true;
                        tabControl1.TabPages[0].Text = "Notificaciones (0)";
		    		}
		    		if(datatable.Rows.Count == 1)
		    		{
		    			statusLbl.Text = "Inventario no actualizado";
		    			uptodatePic2.Image = Resource1._1438227993_face_sad;
		    			statusLbl.ForeColor = Color.Red;
		    			uptodatePic.Visible = false;
		    			uptodatePic2.Visible = true;
                        tabControl1.TabPages[0].Text = "Notificación ("+ datatable.Rows.Count + ")";
                    }
		    		if(datatable.Rows.Count > 1)
		    		{
		    			statusLbl.Text = "Existen registros para actualizar";
		    			uptodatePic2.Image = Resource1._1438227993_face_sad;
		    			statusLbl.ForeColor = Color.Red;
		    			uptodatePic.Visible = false;
		    			uptodatePic2.Visible = true;

                        tabControl1.TabPages[0].Text = "Notificaciones (" + datatable.Rows.Count + ")";
                    }
    			}
    			else
    			{
    				    statusLbl.Text = "No hay regitros de Inventario";
		...
		void UpdateItemQuantityToolStripMenuItemClick(object sender, EventArgs e)
		{
			...
			{
				MessageBox.Show("\nPor favor, ingrese un ítem al inventario", "No item in inventory", MessageBoxButtons.OK, MessageBoxIcon.Asterisk);
			}
		}
        ...
        void GenerateGraph(DataGridView grid)
        {
            ...
            {
                MessageBox.Show("Por favor, contacte al Administrador...", "Error Generating Graph", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
            }
