...
namespace Inventory_System
{
	partial class NewRequest
	{
		...
		private void InitializeComponent()
		{
			...
			this.errorLb1.Text = "No puede dejar campos libres";
			...
			this.toolStripStatusLabel1.Text = "En Stock: ";
			// 
			// Submit
			// 
			...
			this.label9.Text = "Fecha de recepción";
			// 
			// label8
			// 
			...
			this.label8.Text = "Recepcionado por";
			// 
			// label7
			// 
