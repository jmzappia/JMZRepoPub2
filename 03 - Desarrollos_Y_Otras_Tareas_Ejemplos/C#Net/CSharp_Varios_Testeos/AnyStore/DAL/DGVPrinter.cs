...
namespace DGVPrinterHelper 
{
    ...
    public class DGVPrinter
    {
        ...
        //---------------------------------------------------------------------
        // Propiedades. Configurables por usuario.
        //---------------------------------------------------------------------
        #region properties
        ...
        {
            if (EnableLogging) Logger.LogInfoMsg("Proceso iniciado.");
            if (null == dgv) throw new Exception("Parámentro nulo.");
        ...
        {
            if (EnableLogging) Logger.LogInfoMsg("Proceso iniciado.");
            if (null == dgv) throw new Exception("Parámetro nulo.");
            if (!(typeof(DataGridView).IsInstanceOfType(dgv)))
                throw new Exception("Parámetro inválido.");
        ...
        {
            if (EnableLogging) Logger.LogInfoMsg("Iniciando proceso.");
        ...
        {
            if (EnableLogging) Logger.LogInfoMsg("Print: proceso iniciado");
            
            if ((null == dgv))
                throw new Exception("Parámetro nulo.");
        ...
        {
            if (EnableLogging) Logger.LogInfoMsg("BeginPrintEventHandler Ok. Iniciando impresora.");
        ...
        void SetupPrint()
        {
            if (EnableLogging)
            {
                Logger.LogInfoMsg("Configuración de impresora iniciada.");
                var m = printDoc.DefaultPageSettings.Margins;
                Logger.LogInfoMsg(String.Format("Parámetros de impresión iniciales: {0}, {1}, {2}, {3}", m.Left, m.Right, m.Top, m.Bottom));
            }
