    ...
    public partial class frmDeaCust : Form
    {
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            if(success==true)
            {
                ...
                MessageBox.Show("Proveedor o Cliente agregado.");
                Clear();
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            if(success==true)
            {
                ...
                MessageBox.Show("Proveedor o Cliente actualizado.");
                Clear();
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            if(success==true)
            {
                ...
                MessageBox.Show("Proveedor o cliente eliminado.");
                Clear();
