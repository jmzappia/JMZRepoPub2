...
--
-- Host: DESKTOP    Database: laravel-database
-- ------------------------------------------------------
...
--
-- Estructura de tablas movies_db.
--
...
--
-- Acción de "Dumping" a `actor_episode`
--
...
--
-- Estructura de tabla `actor_movie`
--
...
--
-- Acción de "Dumping" a `actor_movie`
--
...
--
-- "Dumping" de datos tabla `migrations`
--
